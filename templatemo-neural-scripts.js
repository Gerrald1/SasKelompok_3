...
// Mobile menu functionality
        ...
        function createQuantumParticle() {
            ...
            particle.style.background = ['#00ffff', '#ff56abff', '#8000ff'][Math.floor(Math.random() * 3)];
        ...
        document.querySelector('.submit-btn').addEventListener('click', function(e) {
            ...
            this.style.background = 'linear-gradient(45deg, #FEF3E2, #FAB12F)';
            
            setTimeout(() => {
                this.innerHTML = 'TRANSMISSION COMPLETE';
                this.style.background = 'linear-gradient(45deg, #FA812F, #DD0303)';
